...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel=createHeader("Java Facts");
		...
		secondButton.addActionListener(this::actionPerformed);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(firstButton.equals(buttonPressed)){
			askQuestion("When your code is underlined red, what kind of error is that?","Compile time error",100);
		...
		// If the buttonPressed was the secondButton
			if(secondButton.equals(buttonPressed)){
				askQuestion("What is Julia's middle name", "Rose",200);
			}
